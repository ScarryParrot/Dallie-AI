...
const Home = () => {
    ...
    function handleSearchChange(e) {
        ...
        setSearchTimeout(
            setTimeout(() => {
                const searchedResult=  allPosts.filter((e) => {
                    const res = e.name.toLowerCase().includes(searchText.toLowerCase()) || e.prompt.toLowerCase().includes(searchText.toLowerCase())
        ...
        <div>
            <section className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3">
                    {
                        searchText ? <RenderCard data={[]} title="NO DATA FOUND" /> :
